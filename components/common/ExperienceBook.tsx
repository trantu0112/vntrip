...
import { getFlightExperience } from '../../api/common-services'
import { useTranslation } from 'react-i18next'

const ExperienceBook: React.FC = () => {
    const { t } = useTranslation(['flight'])
    const [experienceBook, setExperienceBook] = useState<any[]>([])

    useEffect(() => {
        async function fetchData() {
            try {
                const res = await getFlightExperience()
                setExperienceBook(res.data)
            } catch (e) {
                throw e
            }
        }
    ...
    return (
        <div className="experienceBook">
            <div className="container">
                <h2 className="text-center semibold mb30">{t('flight:KINH NGHIỆM ĐẶT VÉ MÁY BAY')}</h2>
                <div className="experienceBook__row">
                    {experienceBook.map((item) => {
                        return (
                            <div className="experienceBook__col" key={item.id}>
                                <a href={item.url} className="experienceBook__item" target="_blank">
                                    <div className="experienceBook__img">
                                        <img src={item.image} />
                                    </div>
                                    <div className="experienceBook__cont">
                                        <div className="experienceBook__title">
                                        ...
                                        <div className="experienceBook__info">
                                            <div className="experienceBook__date">
                                                ...
                                                >
                                                    <path
                                                        d="M4.99984 7H4.33317C4.15636 7 3.98679 7.07024 3.86177 7.19526C3.73674 7.32029 3.6665 7.48986 3.6665 7.66667C3.6665 7.84348 3.73674 8.01305 3.86177 8.13807C3.98679 8.2631 4.15636 8.33333 4.33317 8.33333H4.99984C5.17665 8.33333 5.34622 8.2631 5.47124 8.13807C5.59627 8.01305 5.6665 7.84348 5.6665 7.66667C5.6665 7.48986 5.59627 7.32029 5.47124 7.19526C5.34622 7.07024 5.17665 7 4.99984 7Z"
                                                        fill="#BFBFBF"
                                                    />
                                                    <path
                                                    ...
                                                    />
                                                    <path
                                                        d="M11.6668 7H11.0002C10.8234 7 10.6538 7.07024 10.5288 7.19526C10.4037 7.32029 10.3335 7.48986 10.3335 7.66667C10.3335 7.84348 10.4037 8.01305 10.5288 8.13807C10.6538 8.2631 10.8234 8.33333 11.0002 8.33333H11.6668C11.8436 8.33333 12.0132 8.2631 12.1382 8.13807C12.2633 8.01305 12.3335 7.84348 12.3335 7.66667C12.3335 7.48986 12.2633 7.32029 12.1382 7.19526C12.0132 7.07024 11.8436 7 11.6668 7Z"
                                                        fill="#BFBFBF"
                                                    />
                                                    <path
                                                        d="M4.99984 9.66675H4.33317C4.15636 9.66675 3.98679 9.73699 3.86177 9.86201C3.73674 9.98703 3.6665 10.1566 3.6665 10.3334C3.6665 10.5102 3.73674 10.6798 3.86177 10.8048C3.98679 10.9298 4.15636 11.0001 4.33317 11.0001H4.99984C5.17665 11.0001 5.34622 10.9298 5.47124 10.8048C5.59627 10.6798 5.6665 10.5102 5.6665 10.3334C5.6665 10.1566 5.59627 9.98703 5.47124 9.86201C5.34622 9.73699 5.17665 9.66675 4.99984 9.66675Z"
                                                        fill="#BFBFBF"
                                                    />
                                                    <path
                                                    ...
                                                    />
                                                    <path
                                                        d="M11.6668 9.66675H11.0002C10.8234 9.66675 10.6538 9.73699 10.5288 9.86201C10.4037 9.98703 10.3335 10.1566 10.3335 10.3334C10.3335 10.5102 10.4037 10.6798 10.5288 10.8048C10.6538 10.9298 10.8234 11.0001 11.0002 11.0001H11.6668C11.8436 11.0001 12.0132 10.9298 12.1382 10.8048C12.2633 10.6798 12.3335 10.5102 12.3335 10.3334C12.3335 10.1566 12.2633 9.98703 12.1382 9.86201C12.0132 9.73699 11.8436 9.66675 11.6668 9.66675Z"
                                                        fill="#BFBFBF"
                                                    />
                                                    <path
                                                        d="M4.99984 12.3333H4.33317C4.15636 12.3333 3.98679 12.4035 3.86177 12.5285C3.73674 12.6535 3.6665 12.8231 3.6665 12.9999C3.6665 13.1767 3.73674 13.3463 3.86177 13.4713C3.98679 13.5963 4.15636 13.6666 4.33317 13.6666H4.99984C5.17665 13.6666 5.34622 13.5963 5.47124 13.4713C5.59627 13.3463 5.6665 13.1767 5.6665 12.9999C5.6665 12.8231 5.59627 12.6535 5.47124 12.5285C5.34622 12.4035 5.17665 12.3333 4.99984 12.3333Z"
                                                        fill="#BFBFBF"
                                                    />
                                                    <path
                                            ...
                                            <div className="experienceBook__view">
                                                ...
                                                <span>{`${item.post_view} ` + t('flight: Lượt xem')}</span>
                                            </div>
                                        </div>
                                        <div className="experienceBook__text">
